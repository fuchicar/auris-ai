...
| 🤝 [Contributing](https://github.com/fuchicar/auris-ai/wiki/Contributing) | Fork, branching from `develop`, commit convention, local checks, and how to open a PR against `develop`. |
