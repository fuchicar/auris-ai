...
func TestMarketProviderManageModel_ToggleSelection(t *testing.T) {
	m := newMarketProviderManageModel(NewStyles(ThemeDark, 0), testMarketEntries(), map[string]bool{"fmp": true}, true)
...
func TestMarketProviderManageModel_MoveUp(t *testing.T) {
	m := newMarketProviderManageModel(NewStyles(ThemeDark, 0), testMarketEntries(), nil, true)
...
func TestMarketProviderManageModel_EscNoOpWhenCannotGoBack(t *testing.T) {
	m := newMarketProviderManageModel(NewStyles(ThemeDark, 0), testMarketEntries(), nil, false)
	_, cmd := m.Update(tea.KeyMsg{Type: tea.KeyEsc})
	if cmd != nil {
